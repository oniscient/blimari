...
const AnimatedButton: React.FC<AnimatedButtonProps> = ({ onClick, disabled, isLoading, children }) => {
  return (
    <StyledWrapper>
...
const StyledWrapper = styled.div`
  .button {
    ...
    background-color:rgb(245, 127, 84); /* Orange color */
    border: none 4px solid rgb(225, 158, 132); /* Light gray border to match input */
    color: white;
  ...
  .button:hover {
    border:  2px solid rgb(241, 131, 91); /* Orange border on hover */
    background-color: #E55A2B; /* Darker orange on hover */
  }
  .button:active {
    border: 4px solid #E55A2B; /* Darker orange border on active */
  }
